...
RSpec.describe IketeruCli::Component do
  describe '#initialize' do
    it 'initializes with empty state' do
      component = IketeruCli::Component.new
      expect(component.state).to eq({})
    end

    it 'accepts props' do
      component = IketeruCli::Component.new(title: 'Test')
  ...
  describe 'DSL methods' do
    class TestComponent < IketeruCli::Component
      def render
    ...
    it 'provides box helper method' do
      ...
      expect(result).to be_a(IketeruCli::Box)
    end

    it 'provides text helper method' do
      component = TestComponent.new
      text = component.text("Hello", color: :green)
      expect(text).to be_a(IketeruCli::Text)
