...
RSpec.describe IketeruCli::Text do
  describe '#initialize' do
    it 'stores content and options' do
      text = IketeruCli::Text.new("Hello", color: :green)
  ...
  describe '#render' do
    it 'renders plain text without options' do
      text = IketeruCli::Text.new("Hello")
